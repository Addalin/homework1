...
public class GeoPoint {
	...
	// any computations in hashCode(), equals(), or any other time exact
	// values are required. (Exact values are not required for length and
	// distance computations). Because of this, you should consider using
	// ints for your internal representation of GeoPoint.
