...
public class RouteFormatterGUI extends JPanel {
	...
	public RouteFormatterGUI(JFrame frame) {
		...
		JScrollPane scrlWalkingDirections = new JScrollPane(
		...
		JScrollPane scrlDrivingDirections = new JScrollPane(
	...
	public void addSegment(GeoSegment segment) {
		DefaultListModel<GeoSegment> model = (DefaultListModel<GeoSegment>) (this.lstSegments
				.getModel());
